  ...
  return (
    <section className="w-full py-8 md:py-20 px-[4%] sm:px-[3%] lg:px-[8%] flex flex-col items-center justify-center overflow-hidden">
      <div className="max-w-[1200px] mx-auto w-full flex flex-col items-center justify-center">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 items-stretch gap-5 lg:gap-6 w-full p-5 md:p-6 rounded-[40px] shadow-[0px_2px_10px_5px_rgba(147,_51,_234,_0.05)] bg-white overflow-hidden">
          ...
          <div className="relative z-10 w-full">
            <div className="bg-black rounded-3xl py-5 px-5 sm:px-7 w-full h-full z-[999] relative">
              <div className="space-y-2">
                <div className="bg-[#1e1c28] font-semibold py-2.5 px-4 text-lg flex justify-center items-center rounded-2xl mb-4">
          ...
          <div className="relative z-10 w-full rounded-3xl border border-gray-200 bg-white py-5 px-5 sm:px-7 h-full">
            <div className="mb-4 flex justify-start">
              <div className="w-full inline-flex items-center justify-center px-6 py-2.5 border border-gray-300 rounded-2xl whitespace-nowrap bg-gray-50">
